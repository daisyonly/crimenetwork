...
@Service("suspectStatistics")
public class SuspectStatistics {
    ...
    {   	
    	...
    	for(int i=0;i<=count/onepage;i++){
    		...
    		for(SuspectBaseInfo sbi:readPage.getContent()){ 			
    	...
    	MapHelper.write(edges, "C:\\Users\\Daisy\\Desktop\\mapS.txt");
    }
