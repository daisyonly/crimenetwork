...
public class AddressSimCalculator {
	...
	public static int calculate2(String code1,String code2,String ad1,String ad2){
	...
	public static int calculate(String address1,String address2){
		...
		if(jsonString1==null||jsonString2==null) return 0;
		try {
	...
	private static String normalizeAddress(String address) {
		...
		if(address.endsWith("无")) return null;
		StringBuilder sBuilder=new StringBuilder();
		for(int i=0;i<address.length();i++){
			if(Character.isSpace(address.charAt(i))) continue;
			sBuilder.append(address.charAt(i));
		}
