package org.crimenetwork.modeling.convert;
...
public abstract class Converter <T,F>{
	...
	public T convert(F from, boolean convertConnectNode){
		T to = get();
		setManualField(from,to,convertConnectNode);
		setAuto(from,to);
		return to;
	}
	protected  abstract void setManualField(F from,T to,boolean convertConnectNode);
