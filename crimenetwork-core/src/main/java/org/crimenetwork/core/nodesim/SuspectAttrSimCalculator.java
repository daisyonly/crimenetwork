...
public class SuspectAttrSimCalculator {
	...
	public List<String> getAttrNameList(){
		if(attrNameList==null){
			...
			attrNameList.add("nativeLocation");
			attrNameList.add("gender");
			attrNameList.add("accent");
			...
			attrNameList.add("caseInfo");
		}
		return attrNameList;
	}
	
	public static HashMap<String, Double> computeSimilar(SuspectInfo sbi1,SuspectInfo sbi2){
		...
		simHashMap.put("caseInfo", TextSimCalculator.calculate(sbi1.getCaseInfo(), sbi2.getCaseInfo()));
		return simHashMap;
	}
